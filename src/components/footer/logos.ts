...
export const supporters: Logo[] = [
  ...
  },
  {
    ...
    logo: "src/images/logos/traegerinnen/fiff-schwarz.svg",
...
export const media: Logo[] = [
  {
    name: "Reset",
    logo: "src/images/logos/foerderinnen/logo-reset.svg",
    url: "https://reset.org/",
    alt: "Reset Logo",
  },
  {
...
export const specialThanks: Logo[] = [
  {
    name: "Cleaner Web",
    logo: "src/images/logos/thanks_to/logo-cleaner-web.svg",
    url: "https://cleaner-web.com/",
    alt: "Cleaner Web Logo",
  },
  {
    name: "Uber Space",
    logo: "src/images/logos/thanks_to/logo-uberspace.svg",
